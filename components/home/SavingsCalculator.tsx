...
/**
 * SavingsCalculator — "See How Much You Save With MR 2%"
 * Shows savings vs 6% traditional agent commission.
 * 6% - 2% = 4% savings on the sale price.
 */
...
export default function SavingsCalculator() {
  ...
  const savingsPercent = 4; // always 4% difference
  ...
  return (
    <section className="py-24 md:py-32 bg-[#FAF8F5] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          <span className="section-label">MR 2% Advantage</span>
          <h2 className="font-playfair text-[clamp(2rem,4vw,3.25rem)] font-bold text-[#0A1628] leading-tight mb-4">
            See How Much You Save
          </h2>
          <p className="text-[#6B7280] text-lg max-w-xl mx-auto">
            With our exclusive MR 2% commission, you keep more of what your
            home is worth. See the difference vs. the 6% industry standard.
          </p>
        </motion.div>
            ...
            <div className="px-8 py-10 md:px-12">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-[#FAF8F5] rounded-2xl p-6 border border-[#E8E4DE]">
                  ...
                  <div className="text-[#6B7280] text-xs mb-3">6% commission</div>
                  <div className="font-playfair text-2xl font-bold text-[#0A1628]">
                    {formatCurrency(traditionalCommission)}
                  </div>
                  <div className="text-[#9CA3AF] text-xs mt-1">paid in fees</div>
                </div>

                {/* VS divider */}
                <div className="flex items-center justify-center">
                  <div className="text-[#E8E4DE] font-playfair text-4xl font-light">vs</div>
                </div>
                ...
                <div className="bg-[#0A1628] rounded-2xl p-6 border border-[#0A1628] relative overflow-hidden">
                  ...
                  <div className="text-white/50 text-xs mb-3">2% commission</div>
                  <div className="font-playfair text-2xl font-bold text-[#C5A55A]">
                    {formatCurrency(mrTwoCommission)}
                  </div>
                  <div className="text-white/40 text-xs mt-1">paid in fees</div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-[#C5A55A]/10 to-[#D4BA7A]/5 border border-[#C5A55A]/20 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-[#6B7280] text-xs">
                      {savingsPercent}% less in commission fees
                    </div>
                  </div>
                </div>
                <div className="text-right">
                  ...
                  <div className="text-[#6B7280] text-xs mt-1">kept in your pocket</div>
                </div>
              </div>
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center gap-4">
                ...
                >
                  ...
                  Save {formatCurrency(savings)} — Contact Us
